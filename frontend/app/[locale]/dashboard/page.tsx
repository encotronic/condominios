...
const monthlyData = [
  { month: 'Ene', ingresos: 4200, deudas: 800 },
  { month: 'Feb', ingresos: 5200, deudas: 600 },
  { month: 'Mar', ingresos: 4800, deudas: 1200 },
  { month: 'Abr', ingresos: 5800, deudas: 400 },
  { month: 'May', ingresos: 5100, deudas: 900 },
  { month: 'Jun', ingresos: 6200, deudas: 300 },
];
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={monthlyData}>
                ...
                <Bar dataKey="deudas" name="Deudas" fill="#EF4444" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <button className="p-4 bg-white dark:bg-gray-800 border rounded-xl hover:border-condo-blue transition-all duration-200 flex flex-col items-center justify-center gap-2">
          <TrendingUp className="w-6 h-6 text-condo-blue" />
